...
<div class="min-h-screen bg-custom-blue_dark relative overflow-hidden">
    <div class="inset-0 bg-black opacity-25 absolute"></div>

    <div class="container mx-auto px-6 md:px-12 relative z-10 justify-center items-center py-24 xl:py-40">
...
<!-- svg Image -->
        <div class="m-auto w-full sm:max-w-full mt-6 px-6 py-4">
            <img class="m-auto object-fill" id="logo_img" width="20%" height="auto" src="{{ asset('img/teacher.svg') }}">
        </div>

<!-- text -->
        <div class="m-auto w-full text-center">
            <h1 class="font-roboto-slab text-3xl sm:text-4xl text-white leading-tight mt-4">
            @if (Request::is('login'))
                Prihláste sa
